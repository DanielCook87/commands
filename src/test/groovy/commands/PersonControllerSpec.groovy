...
class PersonControllerSpec extends Specification implements ControllerUnitTest<PersonController>, DataTest{
    ...
    void "Test the save action correctly persists"() {
        given:
        controller.personService = [save:{person->
            person.id = 1
            person
            }] as PersonService
        ...
        def person = new PartialPerson(params)
        // person.id = 1
    ...
    void "Test the update action correctly persists"() {
        given:
        controller.personService = Mock(PersonService) {
            1 * save(_ as Person) >> { Person person -> person.id = 1; person }
        }
